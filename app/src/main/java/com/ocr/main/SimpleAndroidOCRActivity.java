...
public class SimpleAndroidOCRActivity extends Activity {
	public static final String PACKAGE_NAME = "com.ocr.main";
	public static final String DATA_PATH = Environment
			.getExternalStorageDirectory().toString() + "/OCRSimple/";
	...
	protected void onPhotoTaken() {
		...
		Log.d(TAG, "OCR took: "+((System.nanoTime()-startTime)/1000000)+" ms");
		baseApi.end();
